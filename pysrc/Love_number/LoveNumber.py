...
class LoveNumber:
    ...
    def __init__(self, fileDir):
        ...
        self.__path = Path(fileDir)
        self.__lmax = None

        pass

    def getNumber(self, lmax: int, method=LoveNumberType.AOD04):
        self.__lmax = lmax
        func = None
    ...
    def __PREM(self):
        ...
        xnew = np.array(range(0, self.__lmax + 1))
...
def demo():
    ...
    Kn = LN.getNumber(60, LoveNumberType.Wang)
    print(Kn)
    pass
